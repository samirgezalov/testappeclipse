//Модельки для удобного использования в приложении. С наллсейфти не заморачивался,
// и проставил вопросы, для возможного расширения до налл сейфти при необходимости
//Эти модельки автоматически сгенерированны из обьекта Json
